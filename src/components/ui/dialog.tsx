...
const DialogFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 flex-shrink-0 pt-4 border-t border-border mt-4",
      className
    )}
    {...props}
  />
...
const DialogScrollArea = ({
  ...
  <div
    className={cn(
      "flex-1 overflow-y-auto overflow-x-hidden px-1 -mx-1",
      className
    )}
    {...props}
  >
